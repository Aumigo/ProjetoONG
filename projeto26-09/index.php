    ...
    <div class="container-geral">
            ...
            <div class="container">
                ...
                <nav class="js-nav-mobile">
                    <ul class="lista-menu">
                        ...
                        <li><a href="doaçao.php">Faça uma doaçao</a></li>
                        <li><a href="cadastro.php" class="btn-padrao">cadastre-se</a></li>
                        <li><a href="formadm">Administração</a></li>
                        <li><a href="carrinho1.php">
                        <img src="assets/imgs/carrinho.png" alt="Ícone de Carrinho de Compras" style="width: 30px; height: auto;">
                        </a></li>
        ...
        <section class="principal">
            <div class="txt-principal">
                ...
                <a href="nossosanimais.php" class="btn-padrao">Adote um pet!</a>
                <div id="seta"></div>
